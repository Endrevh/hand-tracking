...
objp = np.zeros((29 * 18, 3), np.float32)
objp[:, :2] = np.mgrid[0:18, 0:29].T.reshape(-1, 2)
objp *= square_size
...
images = glob.glob('./calibration_data/image_*.png')  # The path to where the images are stored
